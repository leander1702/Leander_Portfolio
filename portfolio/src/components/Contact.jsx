...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Show popper animation
    triggerPopper('Message Sent Successfully!');
  ...
  return (
    <section id="contact" className="min-h-screen py-16 relative">
      {/* Popper Animation */}
      {showPopper && (
        <div className="fixed top-20 left-1/2 transform -translate-x-1/2 z-50 animate-bounce">
          <div className="bg-gradient-to-r from-green-500 to-emerald-500 text-white px-6 py-4 rounded-2xl shadow-2xl border border-emerald-300/30 backdrop-blur-sm">
            <div className="flex items-center gap-3">
              ...
              <span className="font-semibold text-lg">{popperMessage}</span>
            </div>
            ...
            <div className="bg-gray-800/30 backdrop-blur-sm rounded-2xl p-6 border border-blue-500/20 h-full">
              ...
              <div className="mt-8 pt-6 border-t border-gray-700">
                ...
                <div className="flex space-x-12">
                  {/* LinkedIn */}
                  <a href="https://linkedin.com/in/leander-xavier" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-400 transition-colors group relative">
                  ...
                  {/* Instagram */}
                  <a href="https://instagram.com/yourusername" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-pink-400 transition-colors group relative">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
